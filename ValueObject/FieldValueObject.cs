...
namespace ValueObject
{
        ...
        where T : FieldValueObject<T>
    {
        ...
        private static readonly Func<T, string, object, T> WithFunc = ImmutableObject.With.For<T>();
        ...
        public T With<TValue>(Expression<Func<T, TValue>> fieldExpression, TValue value) =>
            WithFunc(thisAsT, ((MemberExpression)fieldExpression.Body).Member.Name, value);
    }
}
